...
public class AccountActivity extends BaseOnlineActivity implements TakePhoto.TakeResultListener, InvokeListener {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        tv_nickname_real = (TextView) findViewById(R.id.tv_nickname_real);
        ...
        ImageView iv_open_province_flow = (ImageView) findViewById(R.id.iv_open_province_flow);
        ImageView iv_close_province_flow = (ImageView) findViewById(R.id.iv_close_province_flow);
        // 初始化省流模式按钮状态
    ...
    private void showCurVersion() {
        TextView curVersion = (TextView) findViewById(R.id.curVersion);
